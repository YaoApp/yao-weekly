...
![介绍](https://yaoapps.com/doc/介绍/assets/architecture.png)
...
![应用结构](https://yaoapps.com/doc/介绍/assets/yaoapp.png)
...
![XGen](https://yaoapps.com/doc/介绍/assets/xgen.jpg)
...
[更多用法参考 Widget 手册](https://yaoapps.com/doc/手册/Widgets/Index)
...
[更多用法参考 Widget 手册](https://yaoapps.com/doc/手册/处理器/Compute)
...
![服务配置](https://yaoapps.com/doc/基础/assets/yao-setup-step2.jpg)

### 文件系统处理器 & JS API

新增一组文件系统处理器和 JS API。

[查看处理器手册](https://yaoapps.com/doc/手册/处理器/FileSystem)

### HTTP 请求处理器 & JS API

新增一组 HTTP 请求处理器和 JS API。

[查看处理器手册](https://yaoapps.com/doc/手册/处理器/HTTP)

### 更多处理器

新增编码解码、加密解密、证书导入等处理器。

[查看处理器手册](https://yaoapps.com/doc/手册/处理器/Index)
...
![studio](https://yaoapps.com/doc/介绍/assets/studio.jpg)

## Yao Brain

**最好的工具, 你应该感受不到它的存在。**

![Brain](https://yaoapps.com/doc/介绍/assets/yao-brain.jpg)
